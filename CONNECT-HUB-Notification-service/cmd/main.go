...
import (
	...
	"github.com/ARunni/ConnetHub_Notification/pkg/di"
)

func main() {
	logrusLogger, logrusLogFile := logging.InitLogrusLogger("./Logging/connectHub_Notification.log")
	defer logrusLogFile.Close()

	logrusLogger.Info("connectHub_Notification main file started")
	...
	logrusLogger.Info("connectHub_Notification started")
	server.Start()
}
