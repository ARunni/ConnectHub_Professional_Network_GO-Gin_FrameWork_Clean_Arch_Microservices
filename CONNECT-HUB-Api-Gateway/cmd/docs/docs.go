        ...
        "/notifications": {
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Failed to mark notification as read: missing or incorrect parameters",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/notifications/all": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Failed to retrieve notifications: User ID not found or incorrect parameters",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Failed to mark notifications as read: User ID not found or incorrect parameters",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/recruiter/interview": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Failed to cancel interview schedule: missing or incorrect parameters",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
